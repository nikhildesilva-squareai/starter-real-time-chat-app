...
![Intermediate](https://img.shields.io/badge/difficulty-intermediate-F59E0B) ![Full Stack Development](https://img.shields.io/badge/course-Full%20Stack%20Development-0056CE) ![14 hours](https://img.shields.io/badge/estimated-14h-lightgrey)

> **Square 1 AI** starter template — Full Stack Development

## Overview

In this intermediate-level project, you'll build a **Real-time Chat App** using Next.js, WebSockets, Redis. Build a real-time chat application with rooms, typing indicators, and presence. This is a hands-on project where you'll write real code, solve real problems, and build something you can showcase in your portfolio.

This project is part of the **Full Stack Development** course, where you'll build production-grade web applications from database to UI.
...
```bash
# Clone this template
git clone https://github.com/nikhildesilva-squareai/starter-real-time-chat-app.git
cd starter-real-time-chat-app
...
This project builds skills directly applicable to roles like: **Full Stack Developer, Software Engineer, Web Developer**.
